...
2. Assigns policies to cloud MG
...
|------|-------------|------|---------|
| cloud_mg_id | Management Group ID for cloud | string | "" |
| landingzone_mg_id | Management Group ID for LandingZones | string | "" |
| enable_cloud_policies | Enable policies for cloud | bool | true |
| enable_landingzone_policies | Enable policies for LandingZones | bool | true |
| cloud_allowed_vm_skus | Allowed VM SKUs for cloud | list(string) | See variables.tf |
...
| cloud_policy_assignments | Policy assignments for cloud MG |
